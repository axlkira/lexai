                    ...
                    <form method="POST" action="{{ route('clients.store') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <select id="document_type" name="document_type" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                                ...
                                <option value="cedula_ciudadania" {{ old('document_type') == 'cedula_ciudadania' ? 'selected' : '' }}>Cédula de Ciudadanía</option>
                                <option value="tarjeta_identidad" {{ old('document_type') == 'tarjeta_identidad' ? 'selected' : '' }}>Tarjeta de Identidad</option>
                                <option value="registro_civil" {{ old('document_type') == 'registro_civil' ? 'selected' : '' }}>Registro Civil</option>
                                <option value="cedula_extranjeria" {{ old('document_type') == 'cedula_extranjeria' ? 'selected' : '' }}>Cédula de Extranjería</option>
